...
echo "[ab] === scores ==="
echo "-- WITH evidence --"    && python scripts/score_calculator.py "$OUT/ab_with_evidence.jsonl"
echo "-- WITHOUT evidence --" && python scripts/score_calculator.py "$OUT/ab_without_evidence.jsonl"
